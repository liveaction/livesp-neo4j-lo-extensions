...
public class StringTemplateTest {
    ...
    public void shouldApplyTemplateOnASuperComplexString() {
        String result = StringTemplate.template("Je suis chien méchant, elle me fait ${non.existant} manger dans sa ${client.id}. Blabla ${client.id}. Blip blop ${client.tag}", HEADER, LINE);
        assertThat(result).isEqualTo("Je suis chien méchant, elle me fait ${non.existant} manger dans sa 00001. Blabla 00001. Blip blop tag=client,client=tag00001");
    }
