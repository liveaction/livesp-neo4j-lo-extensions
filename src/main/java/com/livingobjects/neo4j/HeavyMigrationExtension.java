...
import com.livingobjects.neo4j.migrations.Informations;
...
public class HeavyMigrationExtension {
    ...
    private final AtomicReference<Migration_2_00_0> migration = new AtomicReference<>();
    ...
    public Response status() throws IOException, ServletException {
        ...
        Informations progression = m2.getProgression();
        if (progression.getStatus())

        return Response.status(Response.Status.CREATED)
                .entity(m2.getMessages())
                .build();
    }
}
